...
echo -e  "Tools    : DoneX5 $white         
" |lolcat
echo -e  "By  : X5 $white   " |lolcat
echo -e  "Blog  : https://github.com/DoneX5/Installer-v4
$white " |lolcat
###################################################
# CTRL + C
###################################################
...
To Exit ... "
echo -e $cyan"[#]> Makasih Beb"
sleep 1
echo ""
echo -e $white"[#]> see you beb :)..."
sleep 1
exit
}
lagi=1
...
6) echo "created by : DoneX5" | lolcat
exit
;;

*) echo "sorry, pilihan yang anda cari salah beb
ada"
esac
done
done
